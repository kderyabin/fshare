...
import com.kderyabin.mvvm.participant.list.PersonListItemView;
...
@Component
@Scope("prototype")
public class BoardEditView implements FxmlView<BoardEditViewModel> {

    final private static Logger LOG = LoggerFactory.getLogger(BoardEditView.class);
    @FXML
